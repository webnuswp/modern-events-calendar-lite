...
class MEC_main extends MEC_base
{
    ...
    */
    ...
    public function get_wp_user_fields()
    {
        ...
        $db = $this->getDB();
        $raw_fields = $db->select("SELECT `meta_key`, `meta_value` FROM `#__usermeta` GROUP BY `meta_key`");
        ...
        set_transient( 'mec-user-meta-keys', $fields, 3600 );
