                    ...
                    <form id="mec_booking_form">
                        ...
                        <div id="booking_option" class="mec-options-fields active">
                            ...
                            <div id="mec_booking_container_toggle" class="<?php if((isset($settings['booking_status']) and !$settings['booking_status']) or !isset($settings['booking_status'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    <label class="mec-col-3" for="mec_settings_booking_ticket_style"><?php esc_html_e('Ticket Style', 'modern-events-calendar-lite'); ?></label>
                                    <div class="mec-col-9">
                                        <select id="mec_settings_booking_ticket_style" name="mec[settings][booking_ticket_style]">
                                            <option value="default" <?php echo ((!isset($settings['booking_ticket_style']) or (isset($settings['booking_ticket_style']) and $settings['booking_ticket_style'] == 'default')) ? 'selected="selected"' : ''); ?>><?php esc_html_e('Default', 'modern-events-calendar-lite'); ?></option>
                                            <option value="row" <?php echo ((isset($settings['booking_ticket_style']) and $settings['booking_ticket_style'] == 'row') ? 'selected="selected"' : ''); ?>><?php esc_html_e('Row', 'modern-events-calendar-lite'); ?></option>
                                        </select>
                                    </div>
                                </div>
